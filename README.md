...
| **🧠 AI 驱动** | 支持 Moonshot 和任意 OpenAI 兼容 API |
...
- **悬浮窗权限**: 用于显示紧急停止按钮
- **API Key**: 从 [Moonshot 开放平台](https://platform.moonshot.cn/) 或任意 OpenAI 兼容 API 提供商获取
...
|--------|---------|----------|---------|
| **Moonshot** | OpenAI Chat Completions | `https://api.moonshot.cn/v1` | `moonshot-v1-8k` |
...
- [Moonshot API](https://platform.moonshot.cn/) - 大语言模型支持
